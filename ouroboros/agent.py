...
from ouroboros.health import (
    verify_restart as health_verify_restart,
    check_uncommitted_changes as health_check_uncommitted_changes,
    check_version_sync as health_check_version_sync,
    check_budget as health_check_budget,
    verify_system_state as health_verify_system_state,
)
...
class OuroborosAgent:
    ...
    def _verify_restart(self, git_sha: str) -> None:
        return health_verify_restart(self.env, git_sha)

    def _check_uncommitted_changes(self) -> Tuple[dict, int]:
        return health_check_uncommitted_changes(self.env)

    def _check_version_sync(self) -> Tuple[dict, int]:
        return health_check_version_sync(self.env)

    def _check_budget(self) -> Tuple[dict, int]:
        return health_check_budget(self.env)

    def _verify_system_state(self, git_sha: str) -> None:
        return health_verify_system_state(self.env, git_sha)
